...
output_dir="${BUILD_ROOT}/perf/jmh/applogs"
...
benchmark_jar_path="${BUILD_ROOT}/perf/jmh/jmh-jdk-microbenchmarks/micros-uber/target/micros-uberpackage-1.0-SNAPSHOT.jar"
