...
output_dir="${TEST_JDK_HOME}/../../../jvmtest/perf/jmh/applogs"
...
benchmark_jar_path="${TEST_JDK_HOME}/../../../jvmtest/perf/jmh/jmh-jdk-microbenchmarks/micros-uber/target/micros-uberpackage-1.0-SNAPSHOT.jar"
